...
chmod 777 $HOME/Desktop/backups
...
cp /etc/passwd $HOME/Desktop/backups/
...
clear
chmod 777 /etc/hosts
cp /etc/hosts $HOME/Desktop/backups/
echo > /etc/hosts
...
cp /etc/lightdm/lightdm.conf $HOME/Desktop/backups/
...
clear
cp /etc/default/irqbalance $HOME/Desktop/backups/
...
clear
cp /etc/sysctl.conf $HOME/Desktop/backups/
...
clear
cp /proc/sys/kernel/sysrq $HOME/Desktop/backups/
echo 0 > /proc/sys/kernel/sysrq
echo "SysRq key has been disabled"

clear
cp /etc/resolv.conf $HOME/Desktop/backups/
echo -e "nameserver 8.8.8.8\nsearch localdomain" >> /etc/resolv.conf
echo "resolv.conf has been configured."

clear
cp /etc/init/control-alt-delete.conf $HOME/Desktop/backups/
...
then
	...
	cp /etc/samba/smb.conf $HOME/Desktop/backups/
...
then
	...
	ufw allow ftps-data
	ufw allow ftps
	cp /etc/vsftpd/vsftpd.conf $HOME/Desktop/backups/
	cp /etc/vsftpd.conf $HOME/Desktop/backups/
...
then
	...
	cp /etc/my.cnf $HOME/Desktop/backups/
	cp /etc/mysql/my.cnf $HOME/Desktop/backups/
	cp /usr/etc/my.cnf $HOME/Desktop/backups/
	cp $HOME/.my.cnf $HOME/Desktop/backups/
	if grep -q "bind-address" "/etc/mysql/my.cnf"
	then
		sed -i "s/bind-address\t\t=.*/bind-address\t\t= 127.0.0.1/g" /etc/mysql/my.cnf
	fi
	gedit /etc/my.cnf&gedit /etc/mysql/my.cnf&gedit /usr/etc/my.cnf&gedit $HOME/.my.cnf
...
then
	...
	ufw allow http
	ufw allow https
	cp /etc/apache2/apache2.conf $HOME/Desktop/backups/
...
if [ $mediaFilesYN == n ]
then
	find / -name "*.midi" -type f >> $HOME/Desktop/Script.log
	find / -name "*.mid" -type f >> $HOME/Desktop/Script.log
	find / -name "*.mod" -type f >> $HOME/Desktop/Script.log
	find / -name "*.mp3" -type f >> $HOME/Desktop/Script.log
	find / -name "*.mp2" -type f >> $HOME/Desktop/Script.log
	find / -name "*.mpa" -type f >> $HOME/Desktop/Script.log
	find / -name "*.m4a" -type f >> $HOME/Desktop/Script.log
	find / -name "*.abs" -type f >> $HOME/Desktop/Script.log
	find / -name "*.mpega" -type f >> $HOME/Desktop/Script.log
	find / -name "*.au" -type f >> $HOME/Desktop/Script.log
	find / -name "*.snd" -type f >> $HOME/Desktop/Script.log
	find / -name "*.wav" -type f >> $HOME/Desktop/Script.log
	find / -name "*.aiff" -type f >> $HOME/Desktop/Script.log
	find / -name "*.aif" -type f >> $HOME/Desktop/Script.log
	find / -name "*.sid" -type f >> $HOME/Desktop/Script.log
	find / -name "*.flac" -type f >> $HOME/Desktop/Script.log
	find / -name "*.ogg" -type f >> $HOME/Desktop/Script.log
	find / -name "*.aac" -type f >> $HOME/Desktop/Script.log
	clear
	echo "All audio files has been listed."

	find / -name "*.mpeg" -type f >> $HOME/Desktop/Script.log
	find / -name "*.mpg" -type f >> $HOME/Desktop/Script.log
	find / -name "*.mpe" -type f >> $HOME/Desktop/Script.log
	find / -name "*.dl" -type f >> $HOME/Desktop/Script.log
	find / -name "*.movie" -type f >> $HOME/Desktop/Script.log
	find / -name "*.movi" -type f >> $HOME/Desktop/Script.log
	find / -name "*.mv" -type f >> $HOME/Desktop/Script.log
	find / -name "*.iff" -type f >> $HOME/Desktop/Script.log
	find / -name "*.anim5" -type f >> $HOME/Desktop/Script.log
	find / -name "*.anim3" -type f >> $HOME/Desktop/Script.log
	find / -name "*.anim7" -type f >> $HOME/Desktop/Script.log
	find / -name "*.avi" -type f >> $HOME/Desktop/Script.log
	find / -name "*.vfw" -type f >> $HOME/Desktop/Script.log
	find / -name "*.avx" -type f >> $HOME/Desktop/Script.log
	find / -name "*.fli" -type f >> $HOME/Desktop/Script.log
	find / -name "*.flc" -type f >> $HOME/Desktop/Script.log
	find / -name "*.mov" -type f >> $HOME/Desktop/Script.log
	find / -name "*.qt" -type f >> $HOME/Desktop/Script.log
	find / -name "*.spl" -type f >> $HOME/Desktop/Script.log
	find / -name "*.swf" -type f >> $HOME/Desktop/Script.log
	find / -name "*.dcr" -type f >> $HOME/Desktop/Script.log
	find / -name "*.dir" -type f >> $HOME/Desktop/Script.log
	find / -name "*.dxr" -type f >> $HOME/Desktop/Script.log
	find / -name "*.rpm" -type f >> $HOME/Desktop/Script.log
	find / -name "*.rm" -type f >> $HOME/Desktop/Script.log
	find / -name "*.smi" -type f >> $HOME/Desktop/Script.log
	find / -name "*.ra" -type f >> $HOME/Desktop/Script.log
	find / -name "*.ram" -type f >> $HOME/Desktop/Script.log
	find / -name "*.rv" -type f >> $HOME/Desktop/Script.log
	find / -name "*.wmv" -type f >> $HOME/Desktop/Script.log
	find / -name "*.asf" -type f >> $HOME/Desktop/Script.log
	find / -name "*.asx" -type f >> $HOME/Desktop/Script.log
	find / -name "*.wma" -type f >> $HOME/Desktop/Script.log
	find / -name "*.wax" -type f >> $HOME/Desktop/Script.log
	find / -name "*.wmv" -type f >> $HOME/Desktop/Script.log
	find / -name "*.wmx" -type f >> $HOME/Desktop/Script.log
	find / -name "*.3gp" -type f >> $HOME/Desktop/Script.log
	find / -name "*.mov" -type f >> $HOME/Desktop/Script.log
	find / -name "*.mp4" -type f >> $HOME/Desktop/Script.log
	find / -name "*.avi" -type f >> $HOME/Desktop/Script.log
	find / -name "*.swf" -type f >> $HOME/Desktop/Script.log
	find / -name "*.flv" -type f >> $HOME/Desktop/Script.log
	find / -name "*.m4v" -type f >> $HOME/Desktop/Script.log
	clear
	echo "All video files have been listed."

	find / -name "*.tiff" -type f >> $HOME/Desktop/Script.log
	find / -name "*.tif" -type f >> $HOME/Desktop/Script.log
	find / -name "*.rs" -type f >> $HOME/Desktop/Script.log
	find / -name "*.im1" -type f >> $HOME/Desktop/Script.log
	find / -name "*.gif" -type f >> $HOME/Desktop/Script.log
	find / -name "*.jpeg" -type f >> $HOME/Desktop/Script.log
	find / -name "*.jpg" -type f >> $HOME/Desktop/Script.log
	find / -name "*.jpe" -type f >> $HOME/Desktop/Script.log
	find / -name "*.png" -type f >> $HOME/Desktop/Script.log
	find / -name "*.rgb" -type f >> $HOME/Desktop/Script.log
	find / -name "*.xwd" -type f >> $HOME/Desktop/Script.log
	find / -name "*.xpm" -type f >> $HOME/Desktop/Script.log
	find / -name "*.ppm" -type f >> $HOME/Desktop/Script.log
	find / -name "*.pbm" -type f >> $HOME/Desktop/Script.log
	find / -name "*.pgm" -type f >> $HOME/Desktop/Script.log
	find / -name "*.pcx" -type f >> $HOME/Desktop/Script.log
	find / -name "*.ico" -type f >> $HOME/Desktop/Script.log
	find / -name "*.svg" -type f >> $HOME/Desktop/Script.log
	find / -name "*.svgz" -type f >> $HOME/Desktop/Script.log
	find / -name "*.bmp" -type f >> $HOME/Desktop/Script.log
	find / -name "*.img" -type f >> $HOME/Desktop/Script.log
	clear
	echo "All image files have been listed."

	find / -name "*.txt" -type f >> $HOME/Desktop/Script.log
	find / -name "*.exe" -type f >> $HOME/Desktop/Script.log
	find / -name "*.msi" -type f >> $HOME/Desktop/Script.log
	find / -name "*.bat" -type f >> $HOME/Desktop/Script.log
	find / -name "*.sh" -type f >> $HOME/Desktop/Script.log
	clear
...
clear
cp /etc/rc.local $HOME/Desktop/backups/
echo > /etc/rc.local
...
dpkg -l | egrep "crack|hack" >> $HOME/Desktop/Script.log
...
clear
cp /etc/login.defs $HOME/Desktop/backups/
...
clear
crontab -l > $HOME/Desktop/backups/crontab-old
crontab -r
...
cp /etc/apt/apt.conf.d/10periodic $HOME/Desktop/backups/
...
then
	...
	cp /etc/apt/sources.list $HOME/Desktop/backups/
...
then
	chmod 777 /etc/apt/sources.list
	cp /etc/apt/sources.list $HOMEDesktop/backups/
...
chmod 777 $HOME/Desktop/logs
echo "Logs folder has been created on the Desktop."

clear
touch $HOME/Desktop/logs/allusers.txt
uidMin=$(grep "^UID_MIN" /etc/login.defs)
uidMax=$(grep "^UID_MAX" /etc/login.defs)
echo -e "User Accounts:" >> $HOME/Desktop/logs/allusers.txt
awk -F':' -v "min=${uidMin##UID_MIN}" -v "max=${uidMax##UID_MAX}" '{ if ( $3 >= min && $3 <= max  && $7 != "/sbin/nologin" ) print $0 }' /etc/passwd >> $HOME/Desktop/logs/allusers.txt
echo -e "\nSystem Accounts:" >> $HOME/Desktop/logs/allusers.txt
awk -F':' -v "min=${uidMin##UID_MIN}" -v "max=${uidMax##UID_MAX}" '{ if ( !($3 >= min && $3 <= max  && $7 != "/sbin/nologin")) print $0 }' /etc/passwd >> $HOME/Desktop/logs/allusers.txt
echo "All users have been logged."
cp /etc/services $HOME/Desktop/logs/allports.log
echo "All ports log has been created."
dpkg -l > $HOME/Desktop/logs/packages.log
echo "All packages log has been created."
apt-mark showmanual > $HOME/Desktop/logs/manuallyinstalled.log
echo "All manually instealled packages log has been created."
service --status-all > $HOME/Desktop/logs/allservices.txt
echo "All running services log has been created."
ps ax > $HOME/Desktop/logs/processes.log
echo "All running processes log has been created."
ss -l > $HOME/Desktop/logs/socketconnections.log
echo "All socket connections log has been created."
sudo netstat -tlnp > $HOME/Desktop/logs/listeningports.log
echo "All listening ports log has been created."
cp /var/log/auth.log $HOME/Desktop/logs/auth.log
echo "Auth log has been created."
cp /var/log/syslog $HOME/Desktop/logs/syslog.log
